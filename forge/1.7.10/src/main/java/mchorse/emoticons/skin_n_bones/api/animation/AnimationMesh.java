...
public class AnimationMesh {
    ...
    public void updateMesh() {
        ...
        final Matrix4f[] matrices = this.currentArmature.matrices;
    ...
    public void render(final Minecraft minecraft, final AnimationMeshConfig AnimationMeshConfig) {
        ...
        final ResourceLocation texture = this.getTexture(AnimationMeshConfig);
        ...
        final float prevLightmapS = OpenGlHelper.lastBrightnessX;
        final float prevLightmapT = OpenGlHelper.lastBrightnessY;
        if (texture != null) {
        ...
        GL11.glColor4f((n >> 16 & 0xFF) / 255.0f, (n >> 8 & 0xFF) / 255.0f, (n & 0xFF) / 255.0f, 1.0f);
        ...
        if (!b3) {
            OpenGlHelper.setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, prevLightmapS, prevLightmapT);
        }
    ...
    private ResourceLocation getTexture(final AnimationMeshConfig AnimationMeshConfig) {
        if (AnimationMeshConfig == null) {
            return this.texture;
        }
