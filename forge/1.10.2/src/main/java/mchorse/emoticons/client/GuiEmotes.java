...
public class GuiEmotes extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.addSetting(17, modelLabel(), "Model: simple");
    ...
    protected void actionPerformed(GuiButton button) throws IOException {
        ...
        if (id == 10 && selectedIndex >= 0 && selectedIndex < filteredKeys.size()) {
            EmoteKeyboardHandler.play((Emote) Emotes.EMOTES.get(filteredKeys.get(selectedIndex)), this.mc.player);
            this.mc.displayGuiScreen(null);
        }
        if (id == 11) {
            EmoteKeyboardHandler.play((Emote) Emotes.EMOTES.get(""), this.mc.player);
        }
        if (id == 12)
        {
    ...
    {
        int w = this.fontRendererObj.getStringWidth(widest) + 12;
    ...
    private void refreshModel()
    {
        ...
        this.controller = new AnimatorEmoticonsController(ec.controller.animationName, ec.controller.userData);
        this.controller.fetchAnimation();
