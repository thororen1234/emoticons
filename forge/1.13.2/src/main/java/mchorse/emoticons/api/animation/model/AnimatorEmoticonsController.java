...
public class AnimatorEmoticonsController extends AnimatorController {
	...
	protected void renderItems(EntityLivingBase livingBase, BOBJArmature armature) {
		...
		ItemStack heldItem = livingBase.getItemStackFromSlot(net.minecraft.inventory.EntityEquipmentSlot.MAINHAND);
	...
	private void updateArmorSlot(AnimationMeshConfig config, EntityLivingBase livingBase, int slot) {
		...
		if (stack != null && stack.getItem() instanceof ItemArmor) {
			...
			if (armor instanceof net.minecraft.item.ItemArmorDyeable) {
				net.minecraft.item.ItemArmorDyeable dyeable = (net.minecraft.item.ItemArmorDyeable) armor;
	...
	private net.minecraft.inventory.EntityEquipmentSlot getSlot(int slot) {
		switch (slot) {
			case SLOT_HEAD:
				return net.minecraft.inventory.EntityEquipmentSlot.HEAD;
			case SLOT_CHEST:
				return net.minecraft.inventory.EntityEquipmentSlot.CHEST;
			case SLOT_LEGS:
				return net.minecraft.inventory.EntityEquipmentSlot.LEGS;
			case SLOT_FEET:
				return net.minecraft.inventory.EntityEquipmentSlot.FEET;
		}
		return net.minecraft.inventory.EntityEquipmentSlot.MAINHAND;
	}
