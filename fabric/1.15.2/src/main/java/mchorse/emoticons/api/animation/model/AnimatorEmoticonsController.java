...
public class AnimatorEmoticonsController extends AnimatorController {
	...
	@Override
	public void renderAnimation(LivingEntity livingBase, MatrixStack matrices,
			VertexConsumerProvider vertexConsumers, int light, AnimationMesh mesh, float yaw,
			float partialTicks) {
		this.updateArmor(livingBase);
		super.renderAnimation(livingBase, matrices, vertexConsumers, light, mesh, yaw, partialTicks);
	}

	@Override
	protected void renderItems(LivingEntity livingBase, MatrixStack matrices,
			VertexConsumerProvider vertexConsumers, int light, BOBJArmature armature) {
